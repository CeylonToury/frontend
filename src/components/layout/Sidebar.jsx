...
const Sidebar = ({ collapsed, userType }) => {
  ...
  const getMenuItems = () => {
    switch (userType) {
      case "CUSTOMER":
        return [
          { key: "/customer/dashboard", icon: <DashboardOutlinedIcon style={iconStyle} />, label: <Link to="/midwife/dashboard">Dashboard</Link> },
          // { key: "/customer/clinics", icon: <HomeOutlinedIcon style={iconStyle} />, label: <Link to="/midwife/clinics">Clinics</Link> },
          // { key: "/customer/babies", icon: <img src={baby} alt="Children" style={{ width: "25px", height: "25px", objectFit: "contain", fontSize: "24px", color: "#4e5052" }} />, label: <Link to="/midwife/babies">Babies</Link> },
          // { key: "/customer/reports", icon: <DescriptionOutlinedIcon style={iconStyle} />, label: <Link to="/midwife/reports">Reports</Link> },
          // { key: "/customer/messages", icon: <MessageOutlinedIcon style={iconStyle} />, label: <Link to="/midwife/messages">Messages</Link> },
        ];
      case "GUIDE":
        return [
          { key: "/guide/dashboard", icon: <DashboardOutlinedIcon style={iconStyle} />, label: <Link to="/guide/dashboard">Dashboard</Link> },
